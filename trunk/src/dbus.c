...
/* VOID:INT,STRING,POINTER (marshal.list:1) */ /*
void
marshal_VOID__INT_STRING_POINTER (GClosure     *closure,
...
void incoming_call_listener(void)
{
 /* 	GError *error;
	...
	dbus_g_object_register_marshaller(marshal_VOID__INT_STRING_POINTER, 
	                                  G_TYPE_NONE, 
	                                  G_TYPE_INT, G_TYPE_STRING, G_TYPE_STRV,
	                                  G_TYPE_INVALID);
	dbus_g_proxy_add_signal(proxy, "CallStatus",
	                        G_TYPE_INT, G_TYPE_STRING, G_TYPE_STRV,
	                        G_TYPE_INVALID);
